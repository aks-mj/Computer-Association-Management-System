    ...
    <div id="main-header">
        ...
        <form method="POST">
            ...
            <div>
                Date of Birth:
                <br>
            <input id="datepicker" placeholder="Birth Date" minlength=<?php echo date('y-m-d')?> class="user-input" name="dob" type="date" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
            </div>
